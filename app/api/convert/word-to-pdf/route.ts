...
export async function POST(request: NextRequest) {
  try {
    ...
    cloudFormData.append("output", "pdf")
    ...
    return new NextResponse(result, { headers: { "Content-Type": "application/pdf" } })
  } catch (error) {
